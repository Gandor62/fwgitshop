...
?>
   	...
   	<div class="container">
		<h1>Edit Tools and Equipment Asset Details</h1>
		<?php
		...
		<div class="card" style="width:100%;">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Edit Asset</strong> <a href="browse-tools.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Small Tools and Equipment</a></div>
			<div class="card-body">
