...
//           'mobilePlan'=>$mobilePlan,
          ...
          'file_name'=>$file_name,   
			...
			if($insert){
				header('location:browse-tools.php?msg=ras');
				exit;
			}else{
				header('location:browse-tools.php?msg=rna');
				exit;
			}
		}else{
...
?>
   	...
   	<div class="container-fluid">
		...
		<h1>Add New Small Tools and Equipment</h1>
		...
		<div class="card" style = "width:100%;">
			...
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Add New Small Tools and Equipment</strong> <a href="browse-tools.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> View Small Tools and Equipment</a></div>
...
<!-- 	  <label { color: #B4886B; font-weight: bold; } >Asset Type - IT Equipment </label> -->
                ...
                <div class="col-3"> 
									<label> Last Asset Number used</label>
										<?php	
									$con = new PDO('mysql:host=localhost;dbname=asset','gandor','#Mellack5');
...
<!-- 							  <label { color: #B4886B; font-weight: bold; display: block; width: 150px; float: center; } >Asset Type - IT Equipment </label> -->
												 ...
												 <input type="hidden" name="assetType" id="assetType" class="form-control form-control-sm" value = "Small Tools and Equipment" placeholder="Small Tools and Equipment"  >
									...
									<?php
										 ...
										 ?>
												<select name="equipmentType" id="equipmentType" class="form-control form-control-sm">
													...
													?>
             			<a href="../assettype/tools/add-tools.php" class="float-left btn btn-light btn-sm">Add</a>
             			 </div>
        ...
        <div class="form-group form-row">			 
					 ...
					 <div class="form-group col" id="otherFieldGroupDiv">
						<div class="row">
							...
							<div class="col-3">
								<label for="otherField1">Next Maintenancent Date</label>
