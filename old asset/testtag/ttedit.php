...
<!--  Security -->
                ...
                <div class="form-group form-row">
                    <div class="col-3">
                        ...
                        <input type="date" name="datePurchased" id="datePurchased" class="form-control form-control-sm" value="<?php echo $row[0]['datePurchased']; ?>" placeholder="Purchased" required  >
                    </div>
                ...
                <div class="form-group form-row">
                    ...
                    <div class="form-group col">
                        ...
                        <input type="number" name="costExGST" id="costExGST" class="form-control form-control-sm"  step="0.01" value="<?php echo $row[0]['costExGST']; ?>"   >
                    </div>
...
<!--                        <input type="text" name="writtenOff" id="writtenOff" class="form-control" value="--><?php //echo $row[0]['writtenOff']; ?><!--" placeholder="Is Written Off"  >-->
<!--                    </div>-->
                ...
                <div class="form-group form-row">
                    ...
                    <div class="form-group col">
                        ...
                        <input type="date" name="dateWrittenOff" id="dateWrittenOff" class="form-control" value="<?php echo $row[0]['dateWrittenOff']; ?>"  >
                    </div>

                    <div class="form-group col" >
                        <label>Reason Written Off</label>
                        <input  type = "text" class="form-control" id="reasonWrittenOff" name="reasonWrittenOff"  rows="3" value="<?php echo $row[0]['reasonWrittenOff']; ?>"></input>
                    </div>
                </div>
                ...
                <!-- <div class="form-group">
                    ...
                    <input type="text" name="file_name" id="file_name" class="form-control" value="<?php echo $row[0]['writtenOff']; ?>" placeholder="Upload Document (To be programmed)"  >
                </div> -->
