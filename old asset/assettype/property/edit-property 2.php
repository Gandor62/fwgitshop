...
if(isset($_REQUEST['editId']) and $_REQUEST['editId']!=""){
	$row	=	$db->getAllRecords('property','*',' AND id="'.$_REQUEST['editId'].'"');
}
...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	$update	=	$db->update('property',$data,array('id'=>$editId));
	if($update){
...
?>
   	...
   	<div class="container">
		...
		?>
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Edit Land and Building Types</strong> <a href="browse-property.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i>Land and Building Types</a></div>
			<div class="card-body">
          ...
          <form method="post">
						...
						<div class="form-group">
							...
							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-edit"></i> Update Land and Building Type</button>
						</div>
					</form>
				</div>
			</div>
