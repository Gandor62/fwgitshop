...
?>
   	...
   	<div class="container">
		...
		?>
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Edit IT and Communication Types</strong> <a href="browse-itequip.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Browse IT and Communication Types</a></div>
			<div class="card-body">
          ...
          <form method="post">
						...
						<div class="form-group">
							...
							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-edit"></i> Update IT and Communication Types</button>
						</div>
					</form>
				</div>
			</div>
