...
$sql 	= $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 ".$condition." AND assetType LIKE 'IT%' AND equipmentType LIKE '%software%'" );

$pages->items_total	=	count($sql);
$pages->mid_range	=	9;
$pages->paginate();

$userData	=   $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 " .$condition. " AND assetType LIKE 'IT%' AND equipmentType LIKE '%software%' ".$pages->limit);

//AND (equipmentType LIKE '%phone%' OR equipmentType LIKE '%tablet%' OR equipmentType LIKE '%mobile%' OR equipmentType LIKE '%ipad%' OR equipmentType LIKE '%radio%')
...
<div class="container-fluid pt-3">
    ...
    <p class = "navleft">  <i class="fas fa-home">  </i> <a href="../main.php">Home </a> > <a href="../assets/asset-page.php">Asset Register </a> > <a href="itselect.php"> IT Assets </a> > Software</p>

    <div class="card">

        <div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Browse IT Software and Licencing</strong>
            ...
            if(count($userData)>0){
                ...
                foreach($userData as $val){
                    ...
                    <tr style="color: blue; font-size: 12px;">
                        ...
                        <td class="text-nowrap"><?php echo $val['area'];?></td>
                        <td class="text-nowrap"><?php echo $val['assignedTo'];?></td>
                        <td class="text-nowrap"><?php echo $val['username'];?></td>
                        <td class="text-nowrap"><?php echo $val['softwareName'];?></td>
                        <td class="text-nowrap"><?php echo $val['password'];?></td>
                        <td class="text-nowrap"><?php echo $val['softVersion'];?></td>
                        <td class="text-nowrap"><?php echo $val['emailaddress'];?></td>
                        <td class="text-nowrap"><?php echo $val['emailPassword'];?></td>


                        <td class="text-nowrap"> <?php echo $val['userLogin'];?></td>
                        <td class="text-nowrap"><?php echo $val['userPassword'];?></td>
                        <td class="text-nowrap"><?php echo $val['pinNumber'];?></td>
                        <td class="text-nowrap"><?php echo $val['cost'];?></td>
                        <td class="text-nowrap"><?php echo $val['costCode'];?></td>
                        <td class="text-nowrap"><?php echo $val['year'];?></td>
                        <td class="text-nowrap"><?php echo $val['SSID'];?></td>
