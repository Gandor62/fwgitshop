...
$_SESSION['parent'] = "peripherals.php";
...
$sql 	= $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 ".$condition." AND assetType LIKE 'IT%' AND (equipmentType LIKE '%peripheral%' OR equipmentType LIKE '%charge%' OR equipmentType LIKE '%printer%' OR equipmentType LIKE '%modem%' OR equipmentType LIKE '%power%' OR equipmentType LIKE '%miscellaneous%' OR equipmentType LIKE '%camera%') AND writtenoff NOT LIKE 'y%' ");

$pages->items_total	=	count($sql);
$pages->mid_range	=	9;
$pages->paginate();

$userData	=   $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 " .$condition. " AND assetType LIKE 'IT%' AND (equipmentType LIKE '%peripheral%' OR equipmentType LIKE '%charge%' OR equipmentType LIKE '%printer%' OR equipmentType LIKE '%modem%' OR equipmentType LIKE '%power%' OR equipmentType LIKE '%miscellaneous%' OR equipmentType LIKE '%camera%') AND writtenoff NOT LIKE 'y%' ORDER by 'site' ASC".$pages->limit);

$_SESSION['condition'] = $condition;
$typeasset = "'IT%'";
$_SESSION['typeasset'] = $typeasset;
$searchfield = "(equipmentType LIKE '%peripheral%' OR equipmentType LIKE '%charge%' OR equipmentType LIKE '%printer%' OR equipmentType LIKE '%modem%' OR equipmentType LIKE '%power%' OR equipmentType LIKE '%miscellaneous%' OR equipmentType LIKE '%camera%')";
...
<div class="container-fluid pt-3">
    ...
    <p class = "navleft">  <i class="fas fa-home">  </i> <a href="../main.php">Home </a> > <a href="../assets/asset-page.php">Asset Register </a> > <a href="itselect.php"> IT Assets </a> > Peripherals</p>

    <div class="card">

<!--        <div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Browse IT Peripherals</strong> <a href="../includes/print.php" target="_blank" class="float-sm-right btn btn-light btn-sm btn-space"><i class="fa fa-print"></i> Print Selection</a><a href="add-it.php" class="float-right btn btn-dark btn-sm btn-space"><i class="fa fa-fw fa-plus-circle"></i> Add Asset</a></div>-->
        <div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Browse IT Computers and Laptops</strong>
