...
$sql 	= $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 ".$condition." AND assetType LIKE 'IT%' AND (equipmentType LIKE '%Computer%' OR equipmentType LIKE '%laptop%' OR equipmentType LIKE '%desktop%' OR equipmentType LIKE '%lap%') AND writtenoff NOT LIKE 'y%' ");

$pages->items_total	=	count($sql);
$pages->mid_range	=	9;
$pages->paginate();

$userData	=   $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 " .$condition. " AND assetType LIKE 'IT%' AND (equipmentType LIKE '%computer%' OR equipmentType LIKE '%laptop%' OR equipmentType LIKE '%desktop%' OR equipmentType LIKE 'lap%' AND writtenoff NOT LIKE 'y%') AND writtenoff NOT LIKE 'y%' ORDER by 'site' ASC ".$pages->limit);
