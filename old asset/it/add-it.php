            ...
            <div class="form-group form-row">
             ...
             <div class="form-group form-row">
                    ...
                    <div class="form-group col">
                        ...
                        <input type="date" name="invoiceDate" id="invoiceDate" class="form-control form-control-sm"  value="<?php echo date('Y-m-d');?>" >
                    </div>


                    <div class="form-group col">
                        <label>Cost Ex GST  </label>
                        <input type="number" name="costExGST" pattern="^\d*(\.\d{0,2})?$" id="costExGST" class="form-control form-control-sm" step="0.01"   value = "0.00""  >
                    </div>
             </div>
                ...
                <div>
                      <div class="form-group" >
                        ...
                        <input  class="form-control" id="itemNotes" name="itemNotes"  rows="3" value = "<?php echo $itemNotes; ?>" ></input>
                      </div>
...
<script src="../includes/js/hide-show-fields-form.js"></script>
