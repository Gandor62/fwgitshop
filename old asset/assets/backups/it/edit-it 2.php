...
//           'equipmentCategory'=>$equipmentCategory,  (Not used)
	...
	if($update){
		header('location: browse-it.php?msg=rus');
		exit;
	}else{
		header('location: browse-it.php?msg=rnu');
		exit;
	}
}
?>
   	...
   	<div class="container">
		...
		<div class="card" style="width:100%;">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Edit Asset</strong> <a href="browse-it.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Asset</a></div>
			<div class="card-body">
...
<!--                 <div class="form-group col">
                  ...
                  <input type="text" name="equipmentCategory" id="equipmentCategory" class="form-control form-control-sm" value="< echo $row[0]['equipmentCategory']; ?>" placeholder="equipmentCategory"  >
						    </div> -->
            ...
            <div class="form-group">
				      ...
				      <div class="form-group">
							...
							<input type="text" name="photo" id="photo" class="form-control" value="<?php echo $row[0]['writtenOff']; ?>" placeholder="Upload Photo"  >
						</div>
