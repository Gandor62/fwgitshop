  ...
  color: grey;
	...
	?>
   	...
   	<div class="container-fluid pt-3">
		...
		<p class = "navleft">  <i class="fas fa-home">  </i> <a href="./../main.php">Home </a> > <a href="/assets/asset-page.php">Asset Register Main </a>> IT Assets </p> 
			...
			<div class="card-body">
              ...
              <div class="col-sm-2">
                  <div class="form-group">
                     ...
                     <input type="text" name="simCard" id="simCard" class="form-control" value="<?php echo isset($_REQUEST['simCard'])?$_REQUEST['simCard']:''?>" placeholder="simCard">
								  </div>
							</div>
         ...
         <div class="col-sm-2">
              ...
              <div class="col-sm-2">
                  <div class="form-group">
                     ...
                     <input type="text" name="costCode" id="costCode" class="form-control" value="<?php echo isset($_REQUEST['costCode'])?$_REQUEST['costCode']:''?>" placeholder="costCode">
								  </div>
							</div>
