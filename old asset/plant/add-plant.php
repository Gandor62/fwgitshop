...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
    ...
    include '../includes/logupdate.php';
...
//          'file_name'=>$file_name,
			...
			if($insert){
				header('location:browse-plant.php?msg=ras');
				exit;
			}else{
				header('location:browse-plant.php?msg=rna');
				exit;
			}
		}else{
...
?>
   	...
   	<div class="container-fluid">
		...
		<h1>Add New Plant and Equipment</h1>
		...
		<div class="card" style = "width:100%;">
			...
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Add New Plant and Equipment</strong> <a href="browse-plant.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> View Plant Equipment</a></div>
...
<!-- 							  <label { color: #B4886B; font-weight: bold; display: block; width: 150px; float: center; } >Asset Type - IT Equipment </label> -->
												 ...
												 <input type="hidden" name="assetType" id="assetType" class="form-control form-control-sm" value = "Plant and Equipment" placeholder="Plant and Equipment"  >
									...
									<?php
										 ...
										 ?>
												<select name="equipmentType" id="equipmentType" class="form-control form-control-sm">
													...
													?>
             			 <a href="../assettype/plant/add-plant.php" class="float-left btn btn-light btn-sm">Add</a>
             			 </div>
...
echo $time = date("Y-m-d", $effectiveDate);?>"  >
        ...
        <div class="form-group form-row">			 
						<div class=" a form-group col-2" >
							<label class="a" for="seeAnotherFieldGroup">Maintenance Required</label>
					 ...
					 <div class="form-group col" id="otherFieldGroupDiv">
						<div class="row">
							...
							<div class="col-3">
								<label for="otherField1">Next Maintenance Date</label>
								<input type="date" name="repairsMaintenanceDate" id="otherField1" class="form-control form-control-sm"   >
							</div>
						
							<div class="col-3">
								<label for="otherField2">Company Maintain</label>
								<input type="text" name="repairer" id="otherField2" class="form-control form-control-sm"  placeholder="Name of Service Provider "  >
      				</div>
							
							 <div class="col-3"> 
                  <label for="otherField3">Service Frequency</label>
<!--                   <input type="text" name="Maintenance Notes" id="otherField3" class="form-control form-control-sm" value = "3 monthly"  placeholder="Maintenance Notes"  > -->
                
							<select class="form-control form-control-sm" name="maintFrequency" id="otherField3" >
							...
							<div class="form-group col 3">
                  <label for="otherField3">Comment</label>
                  <input type="text" name="repairResult" id="otherField4" class="form-control form-control-sm"  placeholder="Result last Maintenance"  >
						  </div>
...
<!--                   <input type="text" name="testTagFrequency" id="otherField2b" class="form-control form-control-sm" placeholder="testTagFrequency"> -->
                ...
                <div class="col-3">
                    ...
                    <input type="date" name="testTagNextDue" id="otherField5b" class="form-control form-control-sm" placeholder="Next Test">
                </div>
            ...
            <div class="form-group form-row">
             ...
             <div class="form-group form-row">
                ...
                <div class="form-group col">
                    ...
                    <input type="date" name="invoiceDate" id="invoiceDate" class="form-control form-control-sm"  placeholder="Invoice Date"  >
                </div>
