...
$_SESSION['parent'] = "browse-fixtures.php";
...
a:active {
  color: grey;
    ...
    if(isset($_REQUEST['costcode']) and $_REQUEST['costcode']!=""){
		...
		$sql 	= $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 ".$condition." AND assetType LIKE 'Fixtures%' ");
		$pages->items_total	=	count($sql);
		$pages->mid_range	=	9;
		$pages->paginate(); 
		 
		$userData	=   $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 ".$condition." AND assetType LIKE 'Fixtures%' ORDER BY id DESC ".$pages->limit."");
	...
	?>
   	...
   	<div class="container-fluid pt-3">
		...
		<p class = "navleft">  <i class="fas fa-home">  </i> <a href="../main.php">Home </a> > <a href="../assets/asset-page.php">Asset Register Main </a>> Fixtures and Fittings </p>

		<div class="card">

			<div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Browse Fixtures and Fittings</strong>
                ...
                <a href="add-fixtures.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Add Asset</a></div>
			...
			<div class="card-body">
              ...
              <div class="col-sm-2">
                  <div class="form-group">
                     ...
                     <input type="text" name="serialNo" id="serialNo" class="form-control" value="<?php echo isset($_REQUEST['serialNo'])?$_REQUEST['serialNo']:''?>" placeholder="If Applicable">
								  </div>
							</div>
         	 ...
         	 <div class="col-sm-2">
                  <div class="form-group">
                     <label>Model</label>
                     <input type="text" name="modelNo" id="modelNo" class="form-control" value="<?php echo isset($_REQUEST['serialNo'])?$_REQUEST['modelNo']:''?>" placeholder="Model">
								  </div>
							</div>
		...
		<div class="container-fluid">
            ...
            <td><?php echo $val['costCode'];?></td>
						...
						<td align="center" style="white-space:nowrap" >
							<a href="edit-fixtures.php?editId=<?php echo $val['id'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Edit</a>| 
