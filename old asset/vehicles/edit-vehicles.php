...
//           'equipmentCategory'=>$equipmentCategory,  (Not used)
	...
	if($update){
		header('location: browse-vehicles.php?msg=rus');
		exit;
	}else{
		header('location: browse-vehicles.php?msg=rnu');
		exit;
	}
}
?>
   	...
   	<div class="container">
		<h1>Edit vehicles and Equipment Asset Details</h1>
		<?php
		...
		<div class="card" style="width:100%;">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Edit Asset</strong> <a href="browse-vehicles.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Browse vehicles and Equipment</a></div>
			<div class="card-body">
          ...
          <form method="post">
            ...
            <div class="form-group form-row">
                <div class="form-group col"> 
                  <label>Brand  </label>
                  <input type="text" name="brand" id="brand" class="form-control form-control-sm" value="<?php echo $row[0]['brand']; ?> ">
                </div>
	
                <div class="form-group col">
                  <label>Model Number  </label>
                  <input type="text" name="modelNo" id="modelNo" class="form-control form-control-sm" value="<?php echo $row[0]['modelNo']; ?>"  >
						    </div>
            
						    <div class="form-group col">
                  <label>Vin No.  </label>
                  <input type="text" name="serialNo" id="serialNo" class="form-control form-control-sm" value="<?php echo $row[0]['serialNo']; ?>" >
						    </div>
			 ...
			 <div class="form-group form-row">			
                ...
                <?php 
				 ...
				 <div class="form-group col">
								...
								<input type="date" name="repairsMaintenanceDate" id="repairsMaintenanceDate" class="form-control form-control-sm"  value="<?php echo $row['repairsMaintenenceDate'];?>" >
							</div>
					 ...
					 <div class="form-group form-row">			 
							...
							<div class="form-group col">
								<label >Company Servicing</label>
								<input type="text" name="repairer" id="repairer" class="form-control form-control-sm"  value ="<?php echo $row[0]['repairer']; ?>" >
      				</div>
							
							
							<div class="form-group col ">
								<label >Current Klms/Hrs</label>
								<input type="text" name="klmsHrs" id="klmsHrs" class="form-control form-control-sm"  value="<?php echo $row[0]['klmsHrs']; ?>" >
      				</div>
                  ...
                  <label>Registration Required </label>
                  		...
                  		<select class="form-control form-control-sm" name="regoRequired" id="regoRequired" value ="<?php echo $row[0]['regoRequired']; ?>" >
													<option value="Required">Required</option>
												<option value="Not Required">Not Required</option>	
											</select>
							    </div>
                  ...
                  <input type="text" name="regoNumber" id="regoNumber" class="form-control form-control-sm" value ="<?php echo $row[0]['regoNumber']; ?>">
						 
								</div>
						
                <div class="form-group col">
                    <label >Registration Expiry Date </label>
                    <input type="date" name="regoExpiryDate" id="regoExpiryDate" class="form-control form-control-sm" value ="<?php echo $row[0]['regoExpiryDate']; ?>">
                </div>
				  ...
				  <div class="form-group form-row">		
						 <div class="form-group col "> 
                  <label>Comment / Notes for next service</label>
                  <input type="text" name="repairResult" id="repairResult" class="form-control form-control-sm"  value ="<?php echo $row[0]['repairResult']; ?>" >
						</div>
					</div>	
            ...
            <div class="form-group form-row">
             ...
             <div class="form-group form-row">
                <div class="col-3"> 
                  ...
                  <input type="date" name="invoiceReference" id="invoiceReference" class="form-control form-control-sm" value="<?php echo $row[0]['invoiceReference']; ?>" placeholder="Invoice Reference"  >
						    </div>
              
                <div class="form-group col">
                    <label>Invoice Date </label>
                    <input type="text" name="invoiceDate" id="invoiceDate" class="form-control form-control-sm" value="<?php echo $row[0]['invoiceDate']; ?>" placeholder="Invoice Date"  >
                </div>
