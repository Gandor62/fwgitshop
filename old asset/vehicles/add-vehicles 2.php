...
?>
   	...
   	<div class="container-fluid">
		...
		<div class="card" style = "width:100%;">
			...
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Add New Vehicle</strong> <a href="browse-vehicles.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> View Fleet </a></div>
			...
			<div class="card-body">
				...
				<div class="form-group form-row ">
								 ...
								 <div class="form-group col-1">
									...
									<input type="hidden" name="assetType" id="assetType" class="form-control form-control-sm" value = "Fleet Vehicles">
             ...
             <div class="form-group form-row ">
                ...
                <div class="form-group col">
                  <label>Model Number / Year </label>
                  <input type="text" name="modelNo" id="modelNo" class="form-control form-control-sm"  placeholder="Model"  >
						    </div>
            
						    <div class="form-group col">
                  <label>Vin / Serial No.  </label>
                  <input type="text" name="serialNo" id="serialNo" class="form-control form-control-sm"  placeholder="Vin Number"  >
						    </div>

                  <div class="form-group col"> 
                  <label for="otherField4b">Last Klms or Hrs  </label>
                  <input type="text" name="klms-Hrs" id="klms-Hrs" class="form-control form-control-sm"  placeholder="Klms or Hours">
              	</div>
							</div>
...
echo $time = date("Y-m-d", $effectiveDate);?>"  >
        ...
        <div class="form-group form-row">			 
							...
							<div class="form-group col">
								...
								<input type="text" name="repairer" id="repairer" class="form-control form-control-sm"  placeholder="Name of Service Provider "  >
      				</div>
...
<!--                   <input type="text" name="Maintenance Notes" id="otherField3" class="form-control form-control-sm" value = "3 monthly"  placeholder="Maintenance Notes"  > -->
							...
							<div class="form-group col">
								...
								<input type="date" name="repairsMaintenanceDate" id="repairsMaintenanceDate" class="form-control form-control-sm"  value="<?php echo date('Y-m-d');?>" >
							</div>
                  ...
                  <label>Registration Required </label>
                  		...
                  		<select class="form-control form-control-sm" name="regoRequired" id="regoRequired" >
                  ...
                  <input type="text" name="regoNumber" id="regoNumber" class="form-control form-control-sm" placeholder="Plate Number">
						 
								</div>
						
                <div class="form-group col">
                    <label >Registration Expiry Date </label>
                    <input type="date" name="regoExpiryDate" id="regoExpiryDate" class="form-control form-control-sm" value="<?php echo date('Y-m-d');?>">
                </div>
