...
//           'equipmentCategory'=>$equipmentCategory,  (Not used)
	...
	if($update){
		header('location: browse-property.php?msg=rus');
		exit;
	}else{
		header('location: browse-property.php?msg=rnu');
		exit;
	}
}
?>
   	...
   	<div class="container">
		<h1>Edit property and Equipment Asset Details</h1>
		<?php
		...
		<div class="card" style="width:100%;">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Edit Asset</strong> <a href="browse-property.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Buildings and Land</a></div>
			<div class="card-body">
