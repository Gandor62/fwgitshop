...
<div class="container">
    ...
    <div class="card" style="width:100%;">
        <div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Edit Asset</strong> <a href="browse-it.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Asset</a>
        </div>
