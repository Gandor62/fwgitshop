...
$sql 	= $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 ".$condition." AND assetType LIKE 'IT%' AND (site LIKE 'IT Stock%' ) AND writtenoff NOT LIKE 'y%'");
$pages->items_total	=	count($sql);
$pages->mid_range	=	9;
$pages->paginate();

$userData	=   $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 " .$condition. " AND assetType LIKE 'IT%' AND (site LIKE 'IT Stock%' ) AND writtenoff NOT LIKE 'y%' ORDER by 'assetNo' ASC ".$pages->limit);
...
$searchfield = "(site LIKE 'IT Stock%' AND writtenoff NOT LIKE 'y%')";
