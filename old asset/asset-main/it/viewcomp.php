...
$sql 	= $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 ".$condition." AND assetType LIKE 'IT%' AND (equipmentType LIKE '%Computer%' OR equipmentType LIKE '%laptop%' OR equipmentType LIKE '%desktop%' OR equipmentType LIKE '%lap%') AND (writtenOff NOT LIKE 'y%' OR writtenOff IS NULL) ");

$pages->items_total	=	count($sql);
$pages->mid_range	=	9;
$pages->paginate();

$userData	=   $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 " .$condition. " AND assetType LIKE 'IT%' AND (equipmentType LIKE '%computer%' OR equipmentType LIKE '%laptop%' OR equipmentType LIKE '%desktop%' OR equipmentType LIKE 'lap%') AND (writtenOff NOT LIKE 'y%' OR writtenOff IS NULL) ORDER by site ASC, assetNo DESC ".$pages->limit);

$_SESSION['condition'] = $condition;
$typeasset = "'IT%'";
$_SESSION['typeasset'] = $typeasset;
$searchfield = "(equipmentType LIKE '%computer%' OR equipmentType LIKE '%laptop%' OR equipmentType LIKE '%desktop%' OR equipmentType LIKE 'lap%')";
...
<div class="container-fluid pt-3">
    ...
    <p class = "navleft">  <i class="fas fa-home">  </i> <a href="../main.php">Home </a> > <a href="../assets/asset-page.php">Asset Register </a> > <a href="itselect.php"> IT Assets </a> > Computers and Laptops</p>
