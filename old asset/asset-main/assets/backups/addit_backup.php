		...
		<div class="card" style = "width:100%;">
            ...
            <div class="col-3"> 
             ...
             <div class="form-group form-row ">
               ...
               <div class="form-group form-row">
                <div class="col-3"> 
                  <label>SimCard  </label>
                  <input type="text" name="simCard" id="simCard" class="form-control form-control-sm"  placeholder="Simcard Number"  >
                </div>
	
                <div class="form-group col">
                  <label>IMEI  </label>
                  <input type="text" name="imei" id="imei" class="form-control form-control-sm"  placeholder="imei"  >
						    </div>
            
						    <div class="form-group col">
                  <label>Mobile Number  </label>
                  <input type="text" name="mobileNumber" id="mobileNumber" class="form-control form-control-sm"  placeholder="Mobile Number"  >
						    </div>
              
                <div class="form-group col">
                  
                  <label>Communications Plan  </label>
                  <input type="text" name="mobilePlan" id="mobilePlan" class="form-control form-control-sm" placeholder="Mobile Plan"  >
						    </div>
            ...
            <div class="form-group form-row">
                  ...
                  <label for= "datePurchased" >Aquired Date  </label>
							...
							<input type="date" name="datePurchased" id="datePurchased" class="form-control form-control-sm"   >
							</div>
                ...
                <div class="form-group col"> 
                  ...
                  <input type="date" name="budgetEnd" id="budgetEnd" class="form-control form-control-sm"   >
						    </div>
           ...
           <div class="form-group form-row">
                <div class="col-3"> 
                  ...
                  <input type="text" name="testTagRequired" id="testTagRequired" class="form-control form-control-sm"  placeholder="testTagRequired">
             	 	</div>
            
						    <div class="form-group col">
                  <label>Frequency</label>
                  <input type="text" name="testTagFrequency" id="testTagFrequency" class="form-control form-control-sm" placeholder="testTagFrequency">
						    </div>
              
                <div class="form-group col">
                    <label>Tested Last Date </label>
                    <input type="text" name="testTagDate" id="testTagDate" class="form-control form-control-sm"  placeholder="Tested Date">
                </div>
               
                <div class="form-group col"> 
                  <label>Tested By  </label>
                  <input type="text" name="testedBy" id="testedBy" class="form-control form-control-sm"  placeholder="Tested By">
              	</div>
            
                <div class="form-group col">
                    <label>Date Next tag Due </label>
                    <input type="text" name="testTagNextDue" id="testTagNextDue" class="form-control form-control-sm" placeholder="Next Test">
                </div>
