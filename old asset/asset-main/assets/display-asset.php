...
a:active {
  color: grey;
    ...
    if(isset($_REQUEST['costcode']) and $_REQUEST['costcode']!=""){
		...
		$sql 	= $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 ");
	...
	?>
   	...
   	<div class="container-fluid pt-3">
		...
		<p class = "navleft">  <i class="fas fa-home">  </i> <a href="./../main.php">Home </a> > <a href="/assets/asset-page.php">Asset Register Main </a>> Assets </p> 

		<div class="card">

			<div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Browse Equipment</strong> <a href="add-it.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Add Asset</a></div>
			...
			<div class="card-body">
              ...
              <div class="col-sm-2">
               ...
               <div class="col-sm-2">
                  <div class="form-group">
                     <label>MEID</label>
                     <input type="text" name="simCard" id="simCard" class="form-control" value="<?php echo isset($_REQUEST['meid'])?$_REQUEST['meid']:''?>" placeholder="Phone Identifier">
								  </div>
							</div>
