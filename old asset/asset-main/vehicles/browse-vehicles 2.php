...
a:active {
  color: grey;
    ...
    if(isset($_REQUEST['costcode']) and $_REQUEST['costcode']!=""){
		...
		$sql 	= $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 ".$condition." AND assetType LIKE 'Fleet%' ");
		$pages->items_total	=	count($sql);
		$pages->mid_range	=	9;
		$pages->paginate(); 
		 
		$userData	=   $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 ".$condition." AND assetType LIKE 'Fleet%' ORDER BY id DESC ".$pages->limit."");
	...
	?>
   	...
   	<div class="container-fluid pt-3">
		...
		<div class="card">
			...
			<div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Browse Vehicles and Fleet</strong> <a href="add-vehicles.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Add Asset</a></div>
