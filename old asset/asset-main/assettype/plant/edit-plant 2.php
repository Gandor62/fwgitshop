...
if(isset($_REQUEST['editId']) and $_REQUEST['editId']!=""){
	$row	=	$db->getAllRecords('plant','*',' AND id="'.$_REQUEST['editId'].'"');
}
...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	$update	=	$db->update('plant',$data,array('id'=>$editId));
	if($update){
...
?>
   	...
   	<div class="container">
		...
		?>
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Edit IT Equipment Types</strong> <a href="browse-plant.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Plant Equipment Types</a></div>
			<div class="card-body">
          ...
          <form method="post">
						...
						<div class="form-group">
							...
							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-edit"></i> Update Plant Equipment Type</button>
						</div>
					</form>
				</div>
			</div>
