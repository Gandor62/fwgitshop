...
if(isset($_REQUEST['editId']) and $_REQUEST['editId']!=""){
	$row	=	$db->getAllRecords('assettype','*',' AND id="'.$_REQUEST['editId'].'"');
}
...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	$update	=	$db->update('assettype',$data,array('id'=>$editId));
	if($update){
		header('location: browse-type.php?msg=rus');
		exit;
	}else{
		header('location: browse-type.php?msg=rnu');
		exit;
	}
}
?>
   	...
   	<div class="container">
		...
		?>
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Edit Asset Types</strong> <a href="browse-type.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Asset Types</a></div>
			<div class="card-body">
          ...
          <form method="post">
						...
						<div class="form-group">
							...
							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-edit"></i> Update Asset Type</button>
						</div>
					</form>
				</div>
			</div>
