...
if(isset($_REQUEST['editId']) and $_REQUEST['editId']!=""){
	$row	=	$db->getAllRecords('tools','*',' AND id="'.$_REQUEST['editId'].'"');
}
...
if(isset($_REQUEST['submit']) and $_REQUEST['submit']!=""){
	...
	$update	=	$db->update('tools',$data,array('id'=>$editId));
	if($update){
		header('location: browse-tools.php?msg=rus');
		exit;
	}else{
		header('location: browse-tools.php?msg=rnu');
		exit;
	}
}
?>
   	...
   	<div class="container">
		...
		?>
		<div class="card">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Edit Small Tools and Equip Types</strong> <a href="browse-tools.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Small Tools and Equipment Types</a></div>
			<div class="card-body">
          ...
          <form method="post">
						...
						<div class="form-group">
							...
							<button type="submit" name="submit" value="submit" id="submit" class="btn btn-primary"><i class="fa fa-fw fa-edit"></i> Update Small Tools and Equipment Type</button>
						</div>
					</form>
				</div>
			</div>
