...
// 					'repairResult'=>$repairResult,
          ...
          'file_name'=>$file_name,   
			...
			if($insert){
				header('location:browse-all.php?msg=ras');
				exit;
			}else{
				header('location:browse-all.php?msg=rna');
				exit;
			}
		}else{
...
?>
   	...
   	<div class="container-fluid">
		...
		<div class="card" style = "width:100%;">
			...
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Add New Asset</strong> <a href="browse-it.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Browse IT</a></div>
