...
$_SESSION['parent'] = "browse-all.php";
	...
	?>
   	...
   	<div class="container-fluid pt-3">
		...
		<div class="card">
			...
			<div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Browse All Assets</strong> <a href="#" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> </a>
		...
		<th>Missing<button class="pull-right btn btn-primary btn-condensed hide-column" data-toggle="tooltip" data-placement="bottom" title="Hide Column">
          <i class="fa fa-eye-slash fa_custom" ></i>  
			...
			<td align="center" style="white-space:nowrap" >
				<a href="edit-all.php" class="text-primary" onClick="return confirm('This is Disabled for now - View Page will be in next upload');"><i class="fab fa-fw fa-readme"></i> View</a>|
