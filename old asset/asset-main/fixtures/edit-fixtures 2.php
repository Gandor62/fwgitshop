...
?>
   	...
   	<div class="container">
		<h1>Edit Fixtures and Fittings Asset Details</h1>
		<?php
		...
		<div class="card" style="width:100%;">
			<div class="card-header"><i class="fa fa-fw fa-plus-circle"></i> <strong>Edit Asset</strong> <a href="browse-fixtures.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-globe"></i> Browse Fixtures and Fitti</a></div>
			<div class="card-body">
