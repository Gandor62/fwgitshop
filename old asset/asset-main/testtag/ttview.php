...
if(isset($_REQUEST['startDate']) and $_REQUEST['startDate']!="") {
    ...
    $condition	.= "	AND testTagNextDue >=  '$from_date' ";
...
if(isset($_REQUEST['endDate']) and $_REQUEST['endDate']!=""){
    ...
    $condition	.=	"	AND testTagNextDue <=  '$to_date' ";
}
...
$sql 	= $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 ".$condition." AND testTagRequired LIKE 'Required' AND writtenoff NOT LIKE 'y%'");

$pages->items_total	=	count($sql);
$pages->mid_range	=	9;
$pages->paginate();

$userData	=   $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 " .$condition. " AND testTagRequired LIKE 'Required'  AND writtenoff NOT LIKE 'y%' ORDER by 'site' ASC ".$pages->limit);
...
$searchfield = "(testTagRequired LIKE 'Required' AND writtenoff LIKE 'n%')";
...
<div class="container-fluid pt-3">
    ...
    <p class = "navleft">  <i class="fas fa-home">  </i> <a href="../main.php"> Home </a> > Test and Tag</p>

    <div class="card">

        <div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Test and Tag </strong>
            ...
            <div class="col-sm-12">
                ...
                <form method="get">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <label>Date Due Test From </label>
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                <label>To End Test Due Date</label>
...
<!--                        <i class="fa fa-eye-slash fa_custom" ></i>-->
<!--                    </button></th>-->
<!--                <th>TT Required <button class="pull-right btn btn-primary btn-condensed hide-column" data-toggle="tooltip" data-placement="bottom" title="Hide Column">-->
<!--                        <i class="fa fa-eye-slash fa_custom" ></i>-->
<!--                    </button></th>-->
                <th>Frequency <button class="pull-right btn btn-primary btn-condensed hide-column" data-toggle="tooltip" data-placement="bottom" title="Hide Column">
                        <i class="fa fa-eye-slash fa_custom" ></i>
                    </button></th>

                    <th>Date Tested <button class="pull-right btn btn-primary btn-condensed hide-column" data-toggle="tooltip" data-placement="bottom" title="Hide Column">
                            <i class="fa fa-eye-slash fa_custom" ></i>
                        </button></th>

                <th>Tag Label Reference <button class="pull-right btn btn-primary btn-condensed hide-column" data-toggle="tooltip" data-placement="bottom" title="Hide Column">
                        <i class="fa fa-eye-slash fa_custom" ></i>
                    </button></th>

                <th>Tester<button class="pull-right btn btn-primary btn-condensed hide-column" data-toggle="tooltip" data-placement="bottom" title="Hide Column">
                        <i class="fa fa-eye-slash fa_custom" ></i>
                    </button></th>

                <th>Next test Due<button class="pull-right btn btn-primary btn-condensed hide-column" data-toggle="tooltip" data-placement="bottom" title="Hide Column">
                        <i class="fa fa-eye-slash fa_custom" ></i>
                    </button></th>
...
<!--                        <td class="text-nowrap">--><?php //echo $val['testTagRequired'];?><!--</td>-->

                        <?php


                        $mf1 = $val['testTagFrequency'];
...
//var_dump($result1);
                        ...
                        <td class="text-nowrap"> <?php echo $result1;?></td>



<!--                        <td class="text-nowrap">--><?php //echo $val['testTagDate'];?><!--</td>-->

                        <?php $wdate = $val["testTagDate"]; $ddate = date("d/m/Y",strtotime($wdate)) ;?>
                        ...
                        <td class="text-nowrap"><?php echo $val['testTagCode'];?></td>

                        <td class="text-nowrap"> <?php echo $val['testedBy'];?></td>

                        <?php $wdate = $val["testTagNextDue"]; $ddate = date("d/m/Y",strtotime($wdate)) ;?>
                        <td class="text-nowrap"><?php echo $ddate; ?></td>
...
<!--                        <td class="text-nowrap">--><?php //echo $val['costExGST'];?><!--</td>-->
                        ...
                        <td align="center" style="white-space:nowrap" >
                            <a href="ttedit.php?editId=<?php echo $val['id'];?>" class="text-primary"><i class="fa fa-fw fa-edit"></i> Edit</a>|
                            <a href="delete.php?delId=<?php echo $val['id'];?>" class="text-danger" onClick="return confirm('Are you sure to delete this Asset?');"><i class="fa fa-fw fa-trash"></i> Delete</a>
                        </td>
