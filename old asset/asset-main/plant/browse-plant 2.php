...
$_SESSION['parent'] = "broese-plant.php";
	...
	?>
   	...
   	<div class="container-fluid pt-3">
		...
		<div class="card">
			...
			<div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Browse Plant and Equipment</strong> <a href="add-plant.php" class="float-right btn btn-dark btn-sm"><i class="fa fa-fw fa-plus-circle"></i> Add Asset</a></div>
