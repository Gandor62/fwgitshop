...
$_SESSION['parent'] = "browse-plant.php";
...
a:active {
  color: grey;
    ...
    if(isset($_REQUEST['costcode']) and $_REQUEST['costcode']!=""){
		...
		$sql 	= $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 ".$condition." AND assetType LIKE 'Plant%' ");
		$pages->items_total	=	count($sql);
		$pages->mid_range	=	9;
		$pages->paginate(); 
		 
		$userData	=   $db->getRecFrmQry("SELECT * FROM assetdata WHERE 1 ".$condition." AND assetType LIKE 'Plant%' ORDER BY id DESC ".$pages->limit."");
   	...
   	<div class="container-fluid pt-3">
		...
		<p class = "navleft">  <i class="fas fa-home">  </i> <a href="../main.php">Home </a> > <a href="../assets/asset-page.php">Asset Register Main </a>> Plant and Equipment Assets </p>

		<div class="card">


			<div class="card-header"><i class="fa fa-fw fa-globe"></i> <strong>Browse Plant and Equipment</strong>
                ...
                <a href="add-plant.php" class="float-right btn btn-dark btn-sm btn-space"><i class="fa fa-fw fa-plus-circle"></i> Add Asset</a></div>
