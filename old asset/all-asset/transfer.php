...
let asset_number = prompt("Please enter asset Number", "");
let text;
...
if(isset($_REQUEST['assetNo']) and $_REQUEST['assetNo']!=""){
    $row	=	$db->getAllRecords('assetdata','*',' AND assetNo="'.$_REQUEST['assetNo'].'"');
}
...
//
//    $sql = "INSERT INTO logfile (assetNo, username,logtime, site, serial, reason, writtenOff) VALUES('$assetNo','$user',CURRENT_TIMESTAMP,'$site','$serialNo','$itemNotes','$writtenOff')";
        ...
        <div class="card-body">
            ...
            <form method="post">
                ...
                <div class="form-group form-row">
                    ...
                    if ($row[0]['writtenOff'] == "Yes") { ?>

                        <div class="form-group col">
                            <label>Date Written Off </label>
                            <?php
                            if (strtotime($row[0]['dateWrittenOff']) != '0000-00-00') {
                                $thedate = date('d-m-Y', strtotime($row[0]['dateWrittenOff']));
                            } else {
                                $thedate = '';
                            }
                            $row[0]['dateWrittenOff'] = $thedate;
                            ?>
